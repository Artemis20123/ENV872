...
-   *Axis ticks and grid lines*: The color, size, and position of the tick marks and grid lines on the axes.
...
2.  Plot the barplot with the reordered factor levels. Add this line of code to make the bars show up left to right: scale_x\_discrete(limits = rev(levels(Neonics\$Endpoint)))
